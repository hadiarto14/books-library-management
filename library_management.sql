...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2022 at 12:38 PM
...
(4, 'To Kill a Mockingbird', 'Harper Lee', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don\'t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn\'t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dicti', 4.25, 'https://images.gr-assets.com/books/1361975680m/2657.jpg', 1, 4),
...
(12, 'Divergent', 'Veronica Roth', 'Quisque aliquam scelerisque viverra. Donec sagittis, est vitae finibus placerat, lorem urna condimentum eros, quis auctor turpis nunc id metus. Nullam eget accumsan eros, at dapibus est. Sed non aliquam nisi. Mauris vitae viverra ipsum. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean vel sem leo. Donec eu sollicitudin sapien, sed luctus diam.', 4.24, 'https://images.gr-assets.com/books/1328559506m/13335037.jpg', 1, 1),
(13, 'City of Bones', 'Cassandra Clare', 'Quisque at odio a nisi ultrices tempor placerat nec enim. Sed dictum leo sed metus sodales, id aliquam eros tristique. Nunc mattis pulvinar suscipit. Etiam semper ultricies tortor at elementum. Quisque sed imperdiet augue. Morbi lorem nisi, convallis a orci id, commodo convallis ligula. Suspendisse id eros et metus finibus cursus sit amet quis diam. Nunc sed dolor et velit tristique eleifend a in ex. In eu efficitur nulla, sit amet sagittis metus. Quisque quis nisl id felis mollis blandit eu rho', 4.12, 'https://images.gr-assets.com/books/1432730315m/256683.jpg', 0, NULL);
...
(9, '2', 'A book that centers on love and relationships as its primary plot element.');
